...
export const HomeList = (props) => {
  ...
  return (
    <>
      <Box className="threeFilterContainer" direction="row-responsive" justify="center">
        <Box background="background-contrast" direction="column" margin="small" pad="xsmall" round="xsmall">
